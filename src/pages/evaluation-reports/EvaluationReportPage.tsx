    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'My Nutrition Evaluation Report',
          text: `Nutrition evaluation report by ${report.user_evaluation_report.dietitian}`,
          ...
          <div className="card-body">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                You haven't completed a nutrition evaluation with Dr. Luna
                Clearwater yet.
              </p>
              <Button asChild>
                <Link to="/coach-chat?persona=drLunaClearwater">
                  Start Nutrition Evaluation
                </Link>
              </Button>
      ...
      <div className="mb-6 flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-muted-foreground">
            Comprehensive nutrition assessments and personalized recommendations
